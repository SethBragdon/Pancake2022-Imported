...
public class Robot extends TimedRobot {
  ...
  // private final CANSparkMax m_leftMotor= new CANSparkMax(1,
  // MotorType.kBrushed);
  // private final CANSparkMax m_rightMotor= new CANSparkMax(2,
  // MotorType.kBrushed);
  ...
  public void teleopPeriodic() {
    ...
    if (m_controller.getLeftBumperPressed()) {
      m_robotDrive.arcadeDrive(m_controller.getLeftY() * 2, m_controller.getRightY() * 2);
    } else {
